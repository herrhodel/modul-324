...
Definieren der erwartete **Artefakte** (z.B. GUI Skizzen, Dokumente usw.) und wo
...
Ein Arbeitspaket ist erst dann **"Done"** wenn die Akzeptanzkriterien <u>auf dem
**Testsystem** erfolgreich durchgeführt</u> wurden.

:::

:::tip Schnelles Kundenfeedback

Wenn das Projekt im DevOps Model mit einer [CI/CD Pipeline](./ci-cd.md)
...
dass nun Teilbereiche der Aufgabe bereits fertiggestellt sind, jedoch noch nicht
...
- Wenn bereits beim erstellen der Arbeitspakete überlegt wird, ob man dieses
  ...
  auseinander. Dies führt dazu dass **eventuelle Probleme schon früher erkennbar
  werden**.
...
3. Es zeigt auf denn **_"Pull-Request"_, also den Code** welche zur
   implementation benötigt wird.

## Kosten / Nutzen der Agilen Vorgehensweise

Bei der Agile Vorgehensweise mit dem DevOps Model, entstehen traditionellerweise
**am Anfang höhere Kosten**, da alle Entwicklungsumgebungen, das Testsystem, die
CI/CD Pipelines usw. aufgebaut werden müssen. Während des Projektes sinken die
Kosten für gewöhnlich.
